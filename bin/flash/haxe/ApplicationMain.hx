...
import de.blogspot.hollowspecter.main.Main;
import nme.Assets;
...
class ApplicationMain {
	...
	private static function begin () {
		...
		for (methodName in Type.getClassFields(de.blogspot.hollowspecter.main.Main))
		{
			if (methodName == "main")
			{
				hasMain = true;
		...
		if (hasMain)
		{
			Reflect.callMethod (de.blogspot.hollowspecter.main.Main, Reflect.field (de.blogspot.hollowspecter.main.Main, "main"), []);
		}
		else
		{
			var instance = Type.createInstance(de.blogspot.hollowspecter.main.Main, []);
